...
const functionRegistry : FunctionRegistry = {
  ...
  supply: function (arg1: any): Promise<MutateEntitiesReturnType> {
    throw new Error("Function not implemented.");
  },
  flashLoan: function (arg1: any): Promise<MutateEntitiesReturnType> {
    throw new Error("Function not implemented.");
  },
  liquidationCall: function (arg1: any): Promise<MutateEntitiesReturnType> {
    throw new Error("Function not implemented.");
  }
};
...
const worker = new Worker("tx-queue", async (job: Job) => {
  ...
  try {
    ...
    throw err; // BullMQ manejará reintentos según la config del job
  }
